...
> ℹ️ *Para consultar el esquema de conexiones detallado, dirígete al apartado de [Diagramas Eléctricos](#34-diagramas-eléctricos).*

### Distribución y Orden de los Sensores

<img src="other/recursos/diagrama wro.png" width="600">

La numeración del 1 al 5 representa la posición física de los sensores en el soporte impreso en 3D (ordenados de izquierda a derecha según el sentido de marcha). Las etiquetas **D1 a D5** del diagrama corresponden a los conectores en la placa donde va enchufado cada uno.
